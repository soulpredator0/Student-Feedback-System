...
<input type="submit" value="Save" class="btn btn-info" name="save" style="background-color:black;border:5px black"/>
<input type="reset" value="Reset" class="btn btn-info" style="background-color:black;border:5px black"/>
