...
<form method="post">
<fieldset>
<center style="background-color:orange;color:white;font-size:25px;border-radius:10px">Student Feedback Form</center><br>
 
<fieldset>



<h3>Express Your Views about in terms of Numbers :</h3>


<button type="button" style="font-size:7pt;color:white;background-color:green;border-radius:5px;border:2px solid #336600;padding:3px">Strongly Agree 5</button>
<button type="button" style="font-size:7pt;color:white;background-color:#ebb434;border-radius:5px;border:2px solid #336600;padding:3px">Agree 4</button>
<button type="button" style="font-size:7pt;color:white;background-color:blue;border-radius:5px;border:2px solid #336600;padding:3px">Neutral 3</button>
<button type="button" style="font-size:7pt;color:white;background-color:Black;border-radius:5px;border:2px solid #336600;padding:3px"> Disagree 2</button>
<button type="button" style="font-size:7pt;color:white;background-color:red;border-radius:5px;border:2px solid #336600;padding:3px">Strongly Disagree 1</button><br>
...
<tr>
<td><b>1:</b> How much of the syllabus was covered in the class?</td>  
...
<tr>
<td><b>2:</b>How well did the teachers prepare for the classes?</td> 
...
<tr>
<td>
<b>3:</b>How well were the teachers able to communicate? </td> 
<td>
...
<h3>2-Class Teaching</h3>
 <table  class="table table-bordered" >
<Td><b>4:</b> The teacher’s approach to teaching can best be described as:</td>
...
<tr>
<td>
<b>5:</b> Fairness of the internal evaluation process by the teachers:</td>
<td> 
...
<p align="center"><button type="submit" style="background-color:black;color:#FF6652;border:5px black;border-radius:5px;padding:3px" name="sub" >Submit</button></p>
