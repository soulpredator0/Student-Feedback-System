...
?>
       ...
       <div class="row">
            <div class="col-md-8">
                <h3><font color="#eb5534">Contact us </font></h3>
                <form name="sentMessage" method="post" id="contactForm" novalidate>
                  <?php echo @$err; ?>
                    ...
                    <button type="submit" name="save" class="btn btn-primary" style="background-color:black;border:5px black">Send Message</button>
					<h1></h1>
                </form>
            </div>
			<div class="col-md-4" style="margin-top:30px">
                <h3 style="background-color:orange;color:white;font-size:25px;border-radius:10px;padding-left:10px; width:200px">Contact Details</h3>
                <p>
                    Kanpur University<br>Kanpur, India 208024<br>
                </p>
