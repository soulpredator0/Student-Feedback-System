...
?>
<h2 align="center" style="color:#eb5534">Update Password</h2>
<form method="post">
	...
	<div class="row" style="margin-top:10px">
		...
		<input type="submit" value="Update Password" name="save" class="btn btn-success" style="background-color:black;border:5px black"/>
		<input type="reset" class="btn btn-success" style="background-color:black;border:5px black"/>
		</div>
	</div>
</form>	