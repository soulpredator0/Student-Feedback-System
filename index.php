    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#000000">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#eb5534">Student Feedback System</a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					 ...
					 <li style="color:#0a0a0a">
                        <a style="color:#ebcf34" href="index.php"><i class="fa fa-home fa-fw"></i>Home</a>
                    </li>
					
					<li style="color:#FFFFFF">
                        <a style="color:#ebcf34" href="index.php?info=about"><i class="fa fa-home fa-fw"></i>About</a>
                    </li>
					
					<li><a style="color:#ebcf34" href="index.php?info=registration"><i class="fa fa-sign-out fa-fw"></i>Registration</a></li>
				
				
								
	<li class="dropdown">
        <a style="color:#ebcf34" href="#" class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-sign-in fa-fw"></i>Login
        <span class="caret"></span></a>
        <ul class="dropdown-menu" style="background-color:#ebcf34">
	 ...
	 <li>
                        <a style="color:#ebcf34" href="index.php?info=contact"><i class="fa fa-phone fa-fw"></i>Contact</a>
                    </li>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('images/feedbackHai1.jpg');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/feedbackHai2.jpg');"></div>
                <div class="carousel-caption">
			 ...
			 <div class="item">
                <div class="fill" style="background-image:url('images/feedbackHai3.jpg');"></div>
                <div class="carousel-caption">
...
Before we can look into the php code, you need to create a database called "feed" with two tables in it..one as student and another one as take
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#000000">
		<span style="color:#ebcf34">Developed By Nikhil Kumar</a> </span>
	</div>
    <!-- jQuery -->
